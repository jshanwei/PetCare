...
public class BridgeService extends Service {
	...
	public void onCreate() {
		...
		NativeCaller.PPPPSetCallbackContext(this);//初始化回调函数环境
	}
	...
	public void VideoData(String did, byte[] videobuf, int h264Data, int len,
		...
		Log.e(TAG, "BridgeService----Call VideoData 这是在VideoData的函数里面...h264Data: "
	...
	public void CallBack_AlarmNotify(String did, int alarmtype) {
		Log.d("tag", "callBack_AlarmNotify did:" + did + " alarmtype:"
				+ alarmtype);
		switch (alarmtype) {
		case ContentCommon.MOTION_ALARM:// 绉诲姩渚︽祴鎶ヨ
	...
	public void CallBack_RecordSchParams(String did, int record_cover_enable,
		...
		Log.e(TAG, "褰曞儚璁″垝:record_schedule_sun_0="+record_schedule_sun_0+",record_schedule_sun_1="+record_schedule_sun_1+",record_schedule_sun_2="+record_schedule_sun_2
